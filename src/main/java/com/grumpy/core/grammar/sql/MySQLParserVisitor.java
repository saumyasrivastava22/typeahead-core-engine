...
public interface MySQLParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MySQLParser#masterTlsCiphersuitesDef}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMasterTlsCiphersuitesDef(MySQLParser.MasterTlsCiphersuitesDefContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MySQLParser#keyListVariants}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitKeyListVariants(MySQLParser.KeyListVariantsContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MySQLParser#createUserEntry}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCreateUserEntry(MySQLParser.CreateUserEntryContext ctx);
	/**
	 * Visit a parse tree produced by {@link MySQLParser#alterUserEntry}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAlterUserEntry(MySQLParser.AlterUserEntryContext ctx);
	/**
